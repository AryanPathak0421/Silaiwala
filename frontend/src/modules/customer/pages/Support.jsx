...
const Support = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-24 font-sans">
            {/* Header */}
            <div className="bg-[#1e3932] px-5 pt-8 pb-16 rounded-b-[3.5rem] relative shrink-0 shadow-2xl shadow-green-900/10">
                ...
                <div className="bg-[#2a4d44] backdrop-blur-md border border-white/5 rounded-[2rem] p-6 flex items-center gap-5 shadow-inner">
                    <div className="h-16 w-16 bg-white rounded-2xl flex items-center justify-center text-[#1e3932] shadow-2xl relative">
            ...
            <div className="max-w-md mx-auto px-5 -mt-6 space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <button className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)] flex flex-col items-center text-center group hover:bg-[#1e3932] transition-all duration-500">
                    ...
                    <button className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)] flex flex-col items-center text-center group hover:bg-[#1e3932] transition-all duration-500">
                        <div className="h-12 w-12 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center mb-4 group-hover:bg-white/20 group-hover:text-white transition-all transform group-hover:scale-110">
                            <Phone size={24} />
                        </div>
                ...
                {/* Email Support */}
                <div className="bg-[#1e3932]/[0.02] rounded-[2.5rem] p-8 border border-gray-100 flex flex-col items-center text-center group hover:bg-white hover:shadow-xl transition-all duration-500">
                    <div className="h-14 w-14 bg-white rounded-2xl flex items-center justify-center text-[#1e3932] shadow-sm mb-4 group-hover:scale-110 transition-transform">
                        <Mail size={28} />
                    </div>
                    ...
                    <a href="mailto:support@tailorapp.com" className="px-8 py-3 bg-[#1e3932] text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-full shadow-lg shadow-green-900/20 hover:scale-105 transition-transform">
